...
description: Using Prometheus & Grafana to monitor AgentUniverse services
---

After deploying the AgentUniverse application, you can monitor the running status and performance metrics of AgentUniverse services using Prometheus & Grafana.

## AgentUniverse Server Metrics

> AgentUniverse Server is the core service of AgentUniverse, exposing metrics such as CPU, memory, and network of the Node.js application.
...
- `scrape_configs[].metrics_path`: The Prometheus metrics endpoint for AgentUniverse Server is `/metrics`.
- `scrape_configs[].static_configs[].targets`: The address and port of the AgentUniverse Server service, you may need to modify it according to the actual deployment.
...
> Conductor is the workflow orchestration engine used by AgentUniverse, exposing metrics such as the number of currently running workflows, completed workflows, failed workflows, JVM memory, database connections, etc.

...
| ------------------------------------------------------------------------------------------ | --------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [AgentUniverse Core Components](https://github.com/inf-monkeys/monkeys)|  AgentUniverse core components, necessary for running this application. | You can use the [AgentUniverse Cloud](https://ai.infmonkeys.com) version, or refer to the local installation guide.  |
| [monkey-tools-wechaty](https://github.com/inf-monkeys/monkey-tools-wechaty)| AgentUniverse Wechaty tool, based on [wechaty](https://github.com/wechaty/wechaty), allows receiving and sending WeChat messages.  | Please refer to the [monkey-tools-wechaty](https://github.com/inf-monkeys/monkey-tools-wechaty) installation guide |
...
After starting the monkey-tools-wechaty project, import it in the AgentUniverse console:
